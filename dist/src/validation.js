...
export function validateAgentName(value, field = 'agent name') {
    if (typeof value !== 'string')
        throw new Error(`${field} must be a string`);
    const v = value.trim();
    if (!v)
...
export function validateCwd(value, field = 'cwd') {
    if (typeof value !== 'string')
        throw new Error(`${field} must be a string`);
    if (!value.trim())
        throw new Error(`${field} cannot be empty`);
...
export function validateRegex(value, field = 'pattern') {
    if (typeof value !== 'string')
        throw new Error(`${field} must be a string`);
...
export function validatePermissionMode(value, field = 'permissionMode') {
    if (typeof value !== 'string')
        throw new Error(`${field} must be a string`);
...
export function validateEffort(value, field = 'effort') {
    if (typeof value !== 'string')
        throw new Error(`${field} must be a string`);
...
export function validateTimeout(value, field = 'timeout') {
...
export function validatePositiveInt(value, field, max) {
...
export function validateStringField(value, field, maxLength = MAX_STRING_FIELD_LENGTH) {
    if (typeof value !== 'string')
        throw new Error(`${field} must be a string`);
...
export function validateStringArray(value, field, maxItems = 200) {
    if (!Array.isArray(value))
        throw new Error(`${field} must be an array`);
    if (value.length > maxItems)
        throw new Error(`${field} must have ≤${maxItems} items`);
